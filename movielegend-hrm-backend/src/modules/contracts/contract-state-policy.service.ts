...
export class ContractStatePolicy {
  private readonly transitions: Record<ContractStatus, ContractStatus[]> = {
    ...
    WAITING_EMPLOYEE_SIGNATURE: [ContractStatus.EMPLOYEE_SIGNED, ContractStatus.CANCELLED, ContractStatus.REJECTED, ContractStatus.ACTIVE, ContractStatus.COMPLETED],
