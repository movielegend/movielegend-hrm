...
export class ContractStatePolicy {
  private readonly transitions: Record<ContractStatus, ContractStatus[]> = {
    ...
    WAITING_EMPLOYEE_SIGNATURE: [ContractStatus.EMPLOYEE_SIGNED, ContractStatus.CANCELLED, ContractStatus.REJECTED, ContractStatus.ACTIVE, ContractStatus.COMPLETED, ContractStatus.WAITING_COMPANY_SIGNATURE],
    EMPLOYEE_SIGNED: [ContractStatus.WAITING_COMPANY_SIGNATURE, ContractStatus.ACTIVE, ContractStatus.COMPLETED],
    WAITING_COMPANY_SIGNATURE: [ContractStatus.COMPLETED, ContractStatus.CANCELLED, ContractStatus.ACTIVE],
