...
const newsfeed_controller_1 = require("./newsfeed.controller");
...
exports.NewsfeedModule = NewsfeedModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [newsfeed_controller_1.NewsfeedController],
        providers: [newsfeed_service_1.NewsfeedService]
    })
], NewsfeedModule);
