...
export declare class AuthService {
    ...
    constructor(prisma: PrismaService, jwtService: JwtService, config: ConfigService, uploads: UploadsService, notifications: NotificationsService);
    ...
    changePassword(userId: string, dto: ChangePasswordDto, actor: AuthenticatedUser): Promise<{
        success: boolean;
    }>;
