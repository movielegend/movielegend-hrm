...
exports.ApprovalsModule = ApprovalsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [approvals_service_1.ApprovalsService, approval_policy_service_1.ApprovalPolicyService],
        exports: [approvals_service_1.ApprovalsService, approval_policy_service_1.ApprovalPolicyService],
    })
], ApprovalsModule);
