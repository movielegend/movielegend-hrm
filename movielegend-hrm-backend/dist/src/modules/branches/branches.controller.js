...
__decorate([
    (0, common_1.Post)(),
    (0, permissions_decorator_1.Permissions)('department.create'),
...
__decorate([
    (0, common_1.Get)('restore-deleted'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], BranchesController.prototype, "restoreDeleted", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, permissions_decorator_1.Permissions)('department.update'),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, permissions_decorator_1.Permissions)('department.delete'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
